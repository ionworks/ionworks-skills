...
The fastest path for any agent — uses the [`skills`](https://www.npmjs.com/package/skills) CLI from
[vercel-labs/skills](https://github.com/vercel-labs/skills) — auto-detects your agent and installs to
the right directory:
...
| Manual | Clone this repo, copy any `<skill-name>/SKILL.md` into your agent's skills or context directory | Frontmatter descriptions act as triggers; bodies are general-purpose guidance. |
...
1. Install the skills:
   ```
   npx skills add ionworks/ionworks-skills -g
   ```
